...
knitr::opts_knit$set(root.dir = "/Users/Nadia/Desktop/resources/data")
...
```{r}
#simulating 400 births based on provided data
n_girls <- rbinom(1, 400, 0.488)
print(n_girls)

#simulate the process 1000 times so we get a better view about the distribution
n_sims <- 1000
